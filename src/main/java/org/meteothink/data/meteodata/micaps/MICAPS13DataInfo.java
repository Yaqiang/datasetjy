 ...
 * @author yaqiang
 */
public class MICAPS13DataInfo extends DataInfo {
    ...
    public void readDataInfo(String fileName) {
        try {
            ...
            this.setCRS(this.getCRS(_lon_Center, _lat_Center, _projOption));
    ...
    private CoordinateReferenceSystem getCRS(double lon_Center, double lat_Center, int projOption) {
