 ...
 */
package org.meteothink.data.meteodata.awx;
 ...
 * @author yaqiang
 */
public class AWXDataInfo extends DataInfo {
    ...
    private void getProjection(byte[] bytes) {
        ...
        if (_productType == 1) //Get grid/projection parameters
        {
            ...
            switch (projType) {
                ...
                case 3:    //极射投影
                    projStr = "+proj=stere"
                            + "+lat_0=" + String.valueOf(_latCenter)
                            + "+lon_0=" + String.valueOf(_lonCenter);
                    double k0 = ProjUtil.calScaleFactorFromStandardParallel(lat1);
            ...
            if (!projStr.equals(this.getCRS().getParameterString())) {
