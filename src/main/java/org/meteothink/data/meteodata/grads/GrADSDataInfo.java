 ...
 */
package org.meteothink.data.meteodata.grads;
 ...
 * @author Yaqiang Wang
 */
public class GrADSDataInfo extends DataInfo {
        ...
        do {
            ...
            switch (hStr) {
                ...
                case "PDEF":
                    ...
                    String ProjStr;
                    CoordinateReferenceSystem theProj;
                    ...
                    switch (pStr) {
                        ...
                        case "LCCR": {
                            ...
                            theProj = ProjUtil.factory(ProjStr);
                            this.setCRS(theProj);
...
//                            }
    ...
    private void getProjectedXY(CoordinateReferenceSystem projInfo, float XSize, float YSize,
            float sync_XP, float sync_YP, float sync_Lon, float sync_Lat,
            double[] X, double[] Y) {
        //Get sync X/Y
        CoordinateReferenceSystem fromProj = KnownCoordinateSystems.geographic.world.WGS1984;
    ...
    public DimArray read(String varName, int[] origin, int[] size, int[] stride) {
        try {
            ...
            if (varName.equals("ensemble")){
                ...
                return new DimArray(dataArray, var.getDimensions(section));
            }
